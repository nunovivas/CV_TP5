...
DONE -> Pinch em cima da bola
DONE -> Movimento da mão enquanto pinch existe (if pinch exists and its inside, elapse time so you can move. 2 seconds... then release)
DONE -> Release
...
PROBLEMS:
Out of bounds -> é preciso mudar muito o código mas pode-se ter um verificador para não deixar sair a bola
Basket -> Needs to spawn at a distance from the borders....
